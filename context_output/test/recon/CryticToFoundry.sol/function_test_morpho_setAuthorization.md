# Function: test_morpho_setAuthorization()
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_morpho_setAuthorization() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [set._inner]
  │       👁️  Def: private
  ├─ [1] ⚙️ FUNCTION: MorphoTargets.morpho_setAuthorization(address,bool) (NodeID: 4)
  ...
  │   💬 Args: [no args]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: MorphoTargets.morpho_setAuthorization(address,bool) (NodeID: 8)
